    ...
    <div class="max-w-7xl mx-auto lg:px-6 lg:px-8 mb-3">
        <div class="bg-dark overflow-hidden shadow-sm sm:rounded-lg mb-3">
            <div class="card border-dark" style="margin:10px;">
                <div class="card-header font-semibold text-lg">{{ __('Create a coronary angiogram admission for patient') }}</div>
                <div class="card-body text-dark">
                    ...
                    @endif
                    <form action="{{ route('coronary_angiogram_admissions.store') }}" method="post">
                        @csrf
                        ...
                        <div class="row items-center justify-start">
                            <div class="col">
                                <div class="form-group mb-3">
                                    ...
                                    <input id="testing_date" type="date" class="form-control" name="testing_date" placeholder="mm-dd-yyyy">
                                </div>
                            </div>
                            <div class="col">
                            <div class="form-group mb-3">
                                    <label for="appointment_date" class="form-label mb-1"><b>{{ __('Appointment Date') }}</b></label>
                                    <input id="appointment_date" type="date" class="form-control" name="appointment_date" placeholder="mm-dd-yyyy">
                                </div>
                            </div>
                        </div>
                        <div class="row items-center justify-start">
                            <div class="col">
                                <div class="form-group mb-3">
                                    ...
                                    <input id="appointment_time" type="time" class="form-control" name="appointment_time" placeholder="HH:MM">
                                </div>  
                            </div>
                            <div class="col">
                                <div class="form-group mb-3">
                                    <label for="appointment_ward" class="form-label mb-1"><b>{{ __('Appointment Ward') }}</b></label>
                                    <input id="appointment_ward" type="text" class="form-control" name="appointment_ward" autocomplete="appointment_ward">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2 item-center">
                            <div class="col">
                                <button type="submit" class="btn btn-primary btn-lg" style="float: right; width: 200px;">
                                    {{ __('Create Coronary Angiogram Admission') }}
                                </button>
                            </div>
                            <div class="col">
