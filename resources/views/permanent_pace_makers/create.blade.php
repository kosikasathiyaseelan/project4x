    ...
    <div class="max-w-7xl mx-auto lg:px-6 lg:px-8 mb-3">
        <div class="bg-dark overflow-hidden shadow-sm sm:rounded-lg mb-3">
            <div class="card border-dark" style="margin:10px;">
                <div class="card-header font-semibold text-lg">{{ __('Create a permanent pace maker for patient') }}</div>
                <div class="card-body text-dark">
                    ...
                    @endif
                    <form action="{{ route('permanent_pace_makers.store') }}" method="post">
                        @csrf
                        ...
                        <div class="row items-center justify-start">
                            ...
                            <div class="col">
                                <div class="form-group mb-3">
                                    ...
                                    <input id="cath_no" type="text" class="form-control" name="cath_no">
                                </div>
                            </div>
                        </div>
                        <div class="row items-center justify-start">
                            <div class="col">
                                <div class="form-group mb-3">
                                    ...
                                    <input id="indication" type="text" class="form-control" name="indication" autocomplete="indication">
                                </div>
                            </div>
                        </div>
                        <div class="row items-center justify-start">
                            <div class="col">
                                <div class="form-group mb-3">
                                    ...
                                    <input id="done_by" type="text" class="form-control" name="done_by" autocomplete="done_by">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2 item-center">
                            <div class="col">
                                <button type="submit" class="btn btn-primary btn-lg" style="float: right; width: 200px;">
                                    {{ __('Create Permanent Pace Makers') }}
                                </button>
                            </div>
                            <div class="col">
