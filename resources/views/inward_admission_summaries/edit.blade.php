                    ...
                    <form action="{{route('inward_admission_summaries.update' ,$InwardAdmissionSummary->id)}}" method="post">
                        ...
                        <div class="col">
                                <div class="form-group mb-3">
                                    ...
                                    <input id="DOA" type="DOA" class="form-control" name="DOA" placeholder="mm-dd-yyyy" value="{{$InwardAdmissionSummary->DOA}}">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group mb-3">
                                    <label for="DOD" class="form-label mb-1"><b>{{ __('DOD') }}</b></label>
                                    <input id="DOD" type="DOD" class="form-control" name="DOD" placeholder="mm-dd-yyyy" value="{{$InwardAdmissionSummary->DOD}}">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group mb-3">
                            ...
                            <div class="col">
                                <div class="form-group mb-3">
                                    ...
                                    <input id="case_no" type="text" class="form-control" name="case_no" value="{{$InwardAdmissionSummary->case_no}}" autocomplete="case_no">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group mb-3">
                        ...
                        <div class="row items-center justify-start">
                           <div class="col">
                                <div class="form-group mb-3">
                                    ...
                                    <input id="Treatment_on_Discharge" type="text" class="form-control" name="Treatment_on_Discharge"  value="{{$InwardAdmissionSummary->Treatment_on_Discharge}}" autocomplete="Treatment_on_Discharge">
                                </div>
                            </div>
                        </div>   
