    ...
    <div class="max-w-7xl mx-auto lg:px-6 lg:px-8 mb-3">
        <div class="bg-dark overflow-hidden shadow-sm sm:rounded-lg mb-3">
            <div class="card border-dark" style="margin:10px;">
                <div class="card-header font-semibold text-lg">{{ __('Create a clinic visit for patient') }}</div>
                <div class="card-body text-dark">
                    ...
                    @endif
                    <form action="{{ route('clinic_visits.store') }}" method="post">
                        @csrf
                        ...
                        <div class="row items-center justify-start">
                            ...
                            <div class="col">
                                <div class="form-group mb-3">
                                    ...
                                    <input id="complaint" type="text" class="form-control" name="complaint" autocomplete="complaint">
                                </div>
                            </div>
                        </div>
                        <div class="row items-center justify-start">
                            <div class="col">
                                <div class="form-group mb-3">
                                    ...
                                    <input id="PR" type="number" class="form-control" name="PR">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea type="text" class="form-control" id="investigation" rows="2" name="investigation"></textarea>
                        </div>
                        <div class="row mt-2 item-center">
                            <div class="col">
                                <button type="submit" class="btn btn-primary btn-lg" style="float: right; width: 200px;">
                                    {{ __('Create Clinic Visit') }}
                                </button>
                            </div>
                            <div class="col">
