    ...
    <div class="max-w-7xl mx-auto lg:px-6 lg:px-8 mb-3">
        <div class="bg-dark overflow-hidden shadow-sm sm:rounded-lg mb-3">
            <div class="card border-dark" style="margin:10px;">
                <div class="card-header font-semibold text-lg">{{ __('Create a Test Appointment for patient') }}</div>
                <div class="card-body text-dark">
                    ...
                    @endif
                    <form action="{{ route('test_appointments.store') }}" method="post">
                        @csrf
                            ...
                            <div class="col">
                                <div class="form-group mb-3">
                                    ...
                                    <select id="Special_Investication" class="form-select" name="Special_Investication">
                                        ...
                                        <option value="2D_Echo ">2D_Echo </option>
                                        <option value="Stress_Echo">Stress_Echo</option>
